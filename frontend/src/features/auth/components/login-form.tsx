            ...
            >
                ...
                <div className="flex justify-end mb-8 relative z-10">
                    <a
                        ...
                        onClick={(e) => {
                            e.preventDefault();
                            handleForgotPassword(form.state.values.email);
                        }}
                        className="relative z-10 cursor-pointer text-sm text-[var(--text-gray)] font-medium hover:text-[var(--primary)] hover:underline decoration-1 underline-offset-2 inline-block"
                    >
                    ...
                    children={([isSubmitting]) => (
                        <div className="flex justify-center relative z-10">
                            <Button
                                ...
                                className="w-fit px-10 h-12 text-lg rounded-xl cursor-pointer transition-all duration-300 hover:shadow-lg hover:brightness-110 active:translate-y-0 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                {isSubmitting ? (
                                    <>
