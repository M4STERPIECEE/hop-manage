...
export const ServicesPage = () => {
    ...
    return (
        <Box>
                    ...
                    {isLoading ? (
                        ...
                        <Table.Root variant="line" size="md">
                            <Table.Header bg="rgba(10, 77, 104, 0.04)">
                                <Table.Row>
                                    <Table.ColumnHeader fontWeight="700" fontSize="0.85rem" color="primary" textTransform="uppercase" letterSpacing="0.5px" py="1rem" px="1.25rem" minW="250px">
                                        Service
                                    </Table.ColumnHeader>
                                    <Table.ColumnHeader fontWeight="700" fontSize="0.85rem" color="primary" textTransform="uppercase" letterSpacing="0.5px" py="1rem" px="1.25rem">
                                        Durée
                                    </Table.ColumnHeader>
                                    <Table.ColumnHeader fontWeight="700" fontSize="0.85rem" color="primary" textTransform="uppercase" letterSpacing="0.5px" py="1rem" px="1.25rem">
                                        Prix
            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} title="Modifier le service">
                <Box>
                    <Flex direction="column" gap="1.25rem">
                        ...
                        <Flex justify="flex-end" gap="1rem" mt="1.5rem">
                            <Button variant="outline" onClick={closeModal} px="1.5rem" py="0.75rem" h="44px" fontSize="0.95rem" fontWeight="600" borderRadius="8px" border="2px solid" borderColor="rgba(10, 77, 104, 0.3)" color="primary" _hover={{ bg: "rgba(10, 77, 104, 0.05)", borderColor: "primary" }}>
                                Annuler
                            </Button>
