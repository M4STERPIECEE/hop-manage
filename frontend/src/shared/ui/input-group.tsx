...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: shadcn input-group primitive intentionally uses role="group"
    <div
...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint: shadcn input-group addon focuses its input on click and intentionally uses role="group"
    <div
      role="group"
