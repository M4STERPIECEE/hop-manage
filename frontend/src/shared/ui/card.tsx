  ...
  return (
    <div
      ...
      className={cn(
        ...
        hoverable &&
          "cursor-pointer shadow-card transition-[box-shadow] duration-200 ease-out hover:shadow-panel hover:ring-2 hover:ring-primary/30",
        className,
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-xs/relaxed text-foreground/40", className)}
      {...props}
    />
  );
}
